...
pub fn get(key: MsgKey) -> &'static str {
    match key {
        ...
        MsgKey::HoverParams => "Parámetros",
        MsgKey::HoverReturns => "Devuelve:",
        ...
        MsgKey::DocTagParam => "Documenta un parámetro",
        MsgKey::DocTagReturn => "Documenta el valor de retorno",
        MsgKey::DocTagRemarks => "Notas adicionales",
